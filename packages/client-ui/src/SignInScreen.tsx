...
export function SignInScreen({ title }: SignInScreenProps) {
...
const styles = StyleSheet.create({
    // flexGrow (not flex: 1) so KeyboardLayout's ScrollView can scroll when the
    // landscape keyboard makes the form taller than the remaining viewport.
    container: {
        flexGrow: 1,
